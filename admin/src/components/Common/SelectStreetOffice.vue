    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-form-item label="选择地区" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <select-area ref="selectAreaAll" :initArea="initCascader" @selectedArea="selectedArea"></select-area>
        </a-form-item>

        <a-form-item label="名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['name']" @blur="searchName($event)" placeholder="请输入地产名称搜索" />
        </a-form-item>

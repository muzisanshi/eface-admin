      ...
      <div>
        <div class="info-item">
          ...
          <input
            type="button"
            class="oper"
            style="height:32px;width:35px;font-size:18px;margin:0 5px 0 10px;background-color: #1890ff;color: #fff;border-radius: 4px;line-height: 26px;cursor: pointer;outline-offset: -4px;"
            value="+"
            title="放大"
            @click="changeScale(1)"/>
          <input
            type="button"
            class="oper"
            style="height:32px;width:35px;font-size:18px;margin:3px 5px;background-color: #1890ff;color: #fff;border-radius: 4px;line-height: 26px;cursor: pointer;outline-offset: -4px;"
            value="-"
            title="缩小"
            @click="changeScale(-1)"/>
          <input
  ...
  methods: {
    ...
    uploadImg (e, num) {
      ...
      reader.onload = (e) => {
        ...
        // 创建对象
        const img = new Image()
        const width = _this.autoWidth // 图片宽度
        const height = _this.autoHeight // 图片高度

...
-->
<template>
  <a-modal :title="title+'组织'" :width="740" :visible="visible" :confirmLoading="confirmLoading" @ok="handleSubmit" @cancel="handleCancel">
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        >
          ...
          <div style="width: 100px;height: 100px;border: 1px solid #cccccc;overflow: hidden;display: inline-block;"><img :src="topImg" alt="" style="width: 100%;"></div>
          <div style="width: 100px;height: 100px;border-radius: 50%;border: 1px solid #cccccc;overflow: hidden;display: inline-block;margin-left: 20px;"><img :src="topImg"  style="width: 100%;" alt=""></div>
          <a-upload
            ...
            @change="handleChange"
          >
            <a-button> <a-icon type="upload" /> 浏览添加 </a-button>
          </a-upload>
        ...
        >
          ...
          <a-cascader :options="options" @change="onChangeAddress" :loadData="loadData" :value='initCascader'  placeholder="选择省市" changeOnSelect/>
        ...
        <a-form-item label="详细地址" :labelCol="labelCol" :wrapperCol="wrapperCol">
          ...
          <p style="margin: 0;height: 20px;color: red" v-if="(longitude =='' || latitude =='') && inputChange !=''">该地址获取不到经纬度</p>
        </a-form-item>

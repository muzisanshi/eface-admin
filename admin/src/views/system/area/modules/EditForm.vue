    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        >
          ...
          <a-cascader :options="options" @change="onChangeAddress" :loadData="loadData" :disabled="disabledSelectParent" :value='initCascader'  placeholder="选择父级区域" changeOnSelect/>
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
        >
          <a-input v-decorator="['postCode', {initialValue: this.formData.postCode,rules: [{required: true, message: '请输入邮政编码！'}]}]" />
        </a-form-item>
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
        >
          <a-input v-decorator="['shortName', {initialValue: this.formData.shortName,rules: [{required: true, message: '请输入简写名称！'}]}]" />
        </a-form-item>
...
export default {
  ...
  methods: {
    add (item,addChild) {
      ...
      //         label: res[i].children[j].children[k].name,
      //         children:[]
      //       }
      //       objCity.children.push(objArea)
      //     }

      ...
      <a-spin :spinning="confirmLoading">
        ...
        <a-form :form="form">
          ...
          <a-form-item label="权限类型" :labelCol="labelCol" :wrapperCol="wrapperCol">
            <a-select showSearch placeholder="选择权限类型" @change="changePermissionType" :disabled="isEdit"
                      optionFilterProp="children" :filterOption="filterCommonOption"
                      :options="constants.list.permissionType"
                      v-decorator="['permissionType', {initialValue: this.formData.permissionType?this.formData.permissionType:'',rules: [{required: true, message: '请选择权限类型！'}]}]">
            </a-select>
          </a-form-item>
          ...
          <a-form-item
            ...
            label="权限名称"
            hasFeedback>
            <a-input placeholder="请输入权限名称"
                     v-decorator="[ 'name', {initialValue: this.formData.name,rules: [{required: true, message: '请输入权限名称！'}]}]"
                     :readOnly="disableSubmit"/>
          </a-form-item>
          ...
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
            label="授权标识">
            <a-input placeholder="如: user:list" v-decorator="[ 'sn',{initialValue: this.formData.sn}]"
                     :readOnly="disableSubmit"/>
          </a-form-item>
          ...
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
            label="资源地址">
            <a-input placeholder="请输入资源地址" v-decorator="[ 'url',{initialValue: this.formData.url}]"
                     :disabled="isDisabledAuth('permission:form:url')" :readOnly="disableSubmit"/>
          </a-form-item>
          ...
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
            label="备注">
            <a-input placeholder="" v-decorator="[ 'remark',{initialValue: this.formData.remark}]"
                     :readOnly="disableSubmit"/>
          </a-form-item>
        </a-form>
      </a-spin>
...
<script>
  ...
  import UserRoleModal from '@/views/system/role/modules/UserRoleModal'
        ...
        if (record && record.id) {
          this.$api.permission.getById({
            ...
            .then(res => {
              ...
              that.parentIds = that.initCheckedKeys;

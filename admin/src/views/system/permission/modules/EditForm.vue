        ...
        <a-form :form="form">
          ...
          <a-form-item
            ...
            >
              <a-tree-select-node v-for="g in treeData" :value="''+g.id" :title="g.name" :key="g.id">
                <a-tree-select-node
                  v-if="g.children&&g.children.length>0"
                  v-for="g1 in g.children"
                  :value="''+g1.id"
                  :title="g1.name"
                  :key="g1.id">
                  <a-tree-select-node
                    v-if="g1.children&&g1.children.length>0"
                    v-for="g2 in g1.children"
                    :value="''+g2.id"
                    :title="g2.name"
                    :key="g2.id">
                    <a-tree-select-node
                      v-if="g2.children&&g2.children.length>0"
                      v-for="g3 in g2.children"
                      :value="''+g3.id"
                      :title="g3.name"
                      :key="g3.id">
                    </a-tree-select-node>
          ...
          <a-form-item
            ...
            <a-input
              ...
              v-decorator="[ 'sn',{initialValue: this.formData.sn}]"
              :readOnly="disableSubmit"/>
          </a-form-item>
          ...
          <a-form-item
            ...
            <a-input
              placeholder="请输入资源地址"
              v-decorator="[ 'url',{initialValue: this.formData.url}]"
              :disabled="isDisabledAuth('permission:form:url')"
              :readOnly="disableSubmit"/>
          </a-form-item>

      ...
      <a-spin :spinning="confirmLoading">
        <a-form :form="form">
          ...
          <a-form-item
            ...
            label="菜单名称"
            hasFeedback >
            <a-input placeholder="请输入菜单名称" v-decorator="[ 'name', {initialValue: this.formData.name,rules: [{required: true, message: '请输入菜单名称！'}]}]" :readOnly="disableSubmit"/>
          </a-form-item>
          ...
          <a-form-item
            ...
            label="菜单标题"
            hasFeedback >
            <a-input placeholder="请输入菜单标题" v-decorator="[ 'title', {initialValue: this.formData.title,rules: [{required: true, message: '请输入菜单标题！'}]}]" :readOnly="disableSubmit"/>
          </a-form-item>
          ...
          <a-form-item
            ...
            <a-tree-select
              ...
              <a-tree-select-node v-for="g in treeData" :value="''+g.id" :title="g.title" :key="g.id">
                <a-tree-select-node v-if="g.children&&g.children.length>0" v-for="g1 in g.children" :value="''+g1.id" :title="g1.title" :key="g1.id">
                  <a-tree-select-node v-if="g1.children&&g1.children.length>0" v-for="g2 in g1.children" :value="''+g2.id" :title="g2.title" :key="g2.id">
                    <a-tree-select-node v-if="g2.children&&g2.children.length>0" v-for="g3 in g2.children" :value="''+g3.id" :title="g3.title" :key="g3.id">
                    </a-tree-select-node>
                  </a-tree-select-node>
                </a-tree-select-node>
              </a-tree-select-node>
          ...
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
            label="菜单路径">
            <a-input placeholder="请输入菜单路径" v-decorator="[ 'path',{initialValue: this.formData.path,rules: [{required: true, message: '请输入菜单路径！'}]}]" :readOnly="disableSubmit"/>
          </a-form-item>
          ...
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
            label="前端组件">
            <a-input placeholder="请输入前端组件" v-decorator="[ 'component',{initialValue: this.formData.component,rules: [{required: true, message: '请输入前端组件！'}]}]" :readOnly="disableSubmit"/>
          </a-form-item>
          ...
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
            label="默认跳转地址">
            <a-input placeholder="请输入路由参数 redirect" v-decorator="[ 'redirect',{initialValue: this.formData.redirect}]" :readOnly="disableSubmit"/>
          </a-form-item>
          ...
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
            label="菜单图标">
            <a-input placeholder="点击右侧按钮选择图标" v-decorator="[ 'icon',{initialValue: this.formData.icon}]" :readOnly="disableSubmit">
          ...
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
            label="排序">
            <a-input-number placeholder="请输入菜单排序" style="width: 200px" v-decorator="[ 'orderNum',{initialValue: this.formData.orderNum,rules: [{required: true, message: '请输入菜单排序！'}]}]" :readOnly="disableSubmit"/>
          </a-form-item>
